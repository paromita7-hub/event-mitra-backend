...
export const seedBookings = async (): Promise<void> => {
  ...
  const bookings = [
    ...
    },
    {
      ...
      advancePaid: 15000,
      status: "confirmed" as const,
      specialRequests: "Pastel theme with photo booth.",
    ...
    {
      venueName: "The Grand Mehta Banquet",
      eventType: "Holi Party",
      eventDate: new Date("2026-03-14"),
      guestCount: 180,
      advancePaid: 80000,
      status: "completed" as const,
      specialRequests: "Organic colours and outdoor setup.",
      createdAt: new Date("2026-02-18"),
    },
    {
      venueName: "Skyline Terrace",
      eventType: "New Year Gala",
      eventDate: new Date("2025-12-31"),
      guestCount: 120,
      advancePaid: 95000,
      status: "completed" as const,
      specialRequests: "Midnight fireworks viewing area.",
      createdAt: new Date("2025-12-10"),
    },
    {
      venueName: "Mehta Garden Villa",
      eventType: "Ganesh Festival",
      eventDate: new Date("2025-09-07"),
      guestCount: 250,
      advancePaid: 120000,
      status: "completed" as const,
      specialRequests: "Traditional mandap decor.",
    ...
    },
    {
      ...
      advancePaid: 200000,
      status: "completed" as const,
      specialRequests: "Indoor AC hall with valet parking.",
